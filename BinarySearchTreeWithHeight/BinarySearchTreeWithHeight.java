...
// Due: 11/2/22
// Complete the code to create and test a new class named BSTWithHeight that extends BST

import java.util.*;

public class BinarySearchTreeWithHeightTomLe {
...
class BSTWithHeight<E> extends BST<E> {
  ...
  private int height(TreeNode<E> root) {
	  ...
	  while (iterator.hasNext()) {
			...
			ArrayList<TreeNode<E>> path = this.path(node);
